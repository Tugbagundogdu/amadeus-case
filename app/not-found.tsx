  ...
  return (
    ...
    <div className="flex flex-col lg:flex-row items-center justify-center h-screen">
      <div className="flex flex-col items-center lg:w-1/2 px-4 lg:px-0">
        <h1 className="text-5xl lg:text-8xl font-extrabold font-serif mb-6 lg:mb-16 text-slate-600 text-center">Oops!</h1>
        <h1 className="text-base lg:text-xl font-mono mb-3 lg:mb-6 text-center">
          Please check the URL or navigate back to the homepage.
        </h1>
        <h1 className="text-base lg:text-lg font-mono mb-3 lg:mb-6 text-center">
          The page you are looking for might have been removed.
        </h1>
        <h1 className="text-base lg:text-lg font-mono mb-6 lg:mb-12 text-center">
        ...
        <div className="relative z-50 cursor-pointer select-none p-2 text-white lg:ml-2 lg:[&>*:nth-child(4)]:hover:skew-y-3">
          ...
          <span className="absolute left-0 top-0 -z-10 h-full w-full -skew-y-3 bg-slate-600 transition-transform"></span>
        </div>
        </Link>
